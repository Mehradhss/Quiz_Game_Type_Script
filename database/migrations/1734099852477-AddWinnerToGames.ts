...
export class AddWinnerToGames1734099852477 implements MigrationInterface {
    name = 'AddWinnerToGames1734099852477'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`game\` ADD \`winnerId\` int NULL`);
